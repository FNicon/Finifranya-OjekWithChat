...
@WebServlet(name = "OrderDriverStatusChatting")
public class OrderDriverStatusChatting extends HttpServlet {
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    setDrivertoChatting((Integer) session.getAttribute("id"));
    session.setAttribute("driverStatus","isChatting");
  ...
  public void setDrivertoChatting(Integer id) {
    ...
    try {
      ...
      preparedStatement.setString(1, "isChatting");
