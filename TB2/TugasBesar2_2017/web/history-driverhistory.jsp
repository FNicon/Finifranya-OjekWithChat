...
<body>
    <div class="container">
        <%
            ...
            out.println(printNavbar("history"));
        %>
        <div class="section">
            ...
            <%
                Service service = WebService.getService("9999", "HistoryData");
                    ...
                    if(hidden_driver!=1) {
                        try {
                            ...
                            while (resultSet.next()) {
                                ...
                                out.println(printProfile(profilePic, (Boolean) session.getAttribute("isDriver"), "profilepic-big"));
                            }
