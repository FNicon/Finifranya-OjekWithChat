...
<body>
    <div class="container">
        <div class="section">
            ...
            <form class="edit" action="UpdateProfile" name="profileedit" method="post">
                <input type="hidden" name="id" value="${sessionScope.id}">
                <div class="edit-profilepic">
                    <div>
                        <%
                            printProfile((String) session.getAttribute("profilePic"), (Boolean) session.getAttribute("isDriver"), "profilepic-big");
                        %>
                    </div>
                ...
                <div class="input-set">
                    ...
                    <div class="field">
                        <input type="text" name="phone" value="${sessionScope.phoneNumber}">
                    </div>
                </div>
                <div class="input-set">
